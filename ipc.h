...
void s_write_card( int, card );//used to to write a player's card to his own index in the array of cards (corresponding to the index in the player's array in server
